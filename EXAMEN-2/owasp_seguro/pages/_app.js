      ...
      <div style={{display: 'flex', alignItems: 'center', gap: '15px'}}>
        <div>
          <div className="app-title">
            <span style={{color: '#00ff41'}}>✓</span> OWASP SECURITY LAB - SEGURO
          </div>
          <div style={{fontSize: '11px', color: '#5599ff', letterSpacing: '1px', opacity: '0.7'}}>
            v2.0.0 | SECURE MODE
          </div>
        </div>
        <span style={{display: 'inline-block', padding: '4px 10px', background: 'rgba(0, 255, 65, 0.1)', border: '1px solid #00ff41', borderRadius: '4px', fontSize: '11px', color: '#00ff41', fontWeight: 'bold'}}>
    ...
    <div>
      ...
      <footer style={{
        ...
        <div style={{marginBottom: '8px'}}>
          OWASP Secure Demo | Desarrollado con fines educativos
        </div>
        <div style={{fontSize: '11px', color: '#66ff99'}}>
          ✓ Protegido contra SQL Injection - Consultas parametrizadas implementadas
        </div>
      </footer>
    </div>
  );
